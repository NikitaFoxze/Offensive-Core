...
{
	// Задний жёлтый фон
	TD_DailyBonus[playerid][0] = CreatePlayerTextDraw(playerid, 273.0000, 170.0000, "");
	PlayerTextDrawTextSize(playerid, TD_DailyBonus[playerid][0], 90.0000, 90.0000);
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][0], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][0], -1147842305);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][0], 5);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][0], 0);
	PlayerTextDrawSetShadow(playerid, TD_DailyBonus[playerid][0], 0);
	...
	// Задний чёрный фон
	TD_DailyBonus[playerid][1] = CreatePlayerTextDraw(playerid, 273.6665, 170.8296, "");
	PlayerTextDrawTextSize(playerid, TD_DailyBonus[playerid][1], 89.0000, 88.0000);
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][1], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][1], 303174399);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][1], 5);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][1], 0);
	...
	TD_DailyBonus[playerid][2] = CreatePlayerTextDraw(playerid, 273.0000, 262.0000, "");
	PlayerTextDrawTextSize(playerid, TD_DailyBonus[playerid][2], 90.0000, 21.0000);
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][2], 1);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][2], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][2], -1717986817);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][2], 5);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][2], 0);
	...
	TD_DailyBonus[playerid][3] = CreatePlayerTextDraw(playerid, 274.0000, 263.0000, "");
	PlayerTextDrawTextSize(playerid, TD_DailyBonus[playerid][3], 88.0000, 19.0000);
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][3], 1);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][3], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][3], 303174399);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][3], 5);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][3], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][4], 2);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][4], -1145325057);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][4], 255);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][4], 2);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][4], 1);
	...
	TD_DailyBonus[playerid][5] = CreatePlayerTextDraw(playerid, 273.0000, 152.0000, "");
	PlayerTextDrawTextSize(playerid, TD_DailyBonus[playerid][5], 90.0000, 16.0000);
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][5], 1);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][5], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][5], 303174399);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][5], 5);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][5], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][6], 2);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][6], -303174657);
	PlayerTextDrawSetOutline(playerid, TD_DailyBonus[playerid][6], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][6], 80);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][6], 2);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][6], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][7], 3);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][7], 1637533439);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][7], 80);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][7], 2);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][7], 1);
	PlayerTextDrawSetShadow(playerid, TD_DailyBonus[playerid][7], 0);

	// Опыт
	TD_DailyBonus[playerid][8] = CreatePlayerTextDraw(playerid, 319.0000, 174.0000, "");
	PlayerTextDrawLetterSize(playerid, TD_DailyBonus[playerid][8], 0.2375, 1.8156);
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][8], 2);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][8], -409396993);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][8], 80);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][8], 2);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][8], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][9], 2);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][9], 649482239);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][9], 80);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][9], 2);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][9], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_DailyBonus[playerid][10], 2);
	PlayerTextDrawColor(playerid, TD_DailyBonus[playerid][10], -371844865);
	PlayerTextDrawBackgroundColor(playerid, TD_DailyBonus[playerid][10], 80);
	PlayerTextDrawFont(playerid, TD_DailyBonus[playerid][10], 2);
	PlayerTextDrawSetProportional(playerid, TD_DailyBonus[playerid][10], 1);
