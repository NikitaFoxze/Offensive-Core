...
stock Mode_ShowTDMatchPoints(playerid) 
{
	...
	PlayerTextDrawAlignment(playerid, TD_MatchPoints[playerid], 1);
	PlayerTextDrawColor(playerid, TD_MatchPoints[playerid], -325353729);
	PlayerTextDrawSetShadow(playerid, TD_MatchPoints[playerid], 1);
	PlayerTextDrawSetOutline(playerid, TD_MatchPoints[playerid], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_MatchPoints[playerid], 153);
	PlayerTextDrawFont(playerid, TD_MatchPoints[playerid], 2);
	PlayerTextDrawSetProportional(playerid, TD_MatchPoints[playerid], 1);
	return 1;
}
...
stock Mode_CreatePlTDTimerSession(playerid) 
{
	...
	PlayerTextDrawAlignment(playerid, TD_TimerSession[playerid], 2);
	PlayerTextDrawColor(playerid, TD_TimerSession[playerid], -1);
	PlayerTextDrawSetShadow(playerid, TD_TimerSession[playerid], 0);
	PlayerTextDrawSetOutline(playerid, TD_TimerSession[playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_TimerSession[playerid], 13107);
	PlayerTextDrawFont(playerid, TD_TimerSession[playerid], 2);
	PlayerTextDrawSetProportional(playerid, TD_TimerSession[playerid], 1);
