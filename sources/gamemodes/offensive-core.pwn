...
#define SERVER_CLIENT				"SA-MP_0.3.7"			// Ссылка на Discord
...
#include <sources/npc/system.pwn>
...
public OnGameModeInit()
{
	...
	SendRconCommand("hostname "SERVER_NAME_CORE"");
	SendRconCommand("weburl "SERVER_VK"");
	SendRconCommand("mapname Uprising");
	...
	ShowNameTags(1);					// Показывает теги с именами игроков
	AllowInteriorWeapons(1);			// Разрешает использовать оружие в интерьерах
...
*/
	...
	TextDrawAlignment(TD_LogoServer[0], 2);
	TextDrawColor(TD_LogoServer[0], -136586497);
	TextDrawBackgroundColor(TD_LogoServer[0], 606348543);
	TextDrawFont(TD_LogoServer[0], 1);
	TextDrawSetProportional(TD_LogoServer[0], 1);
	...
	TextDrawAlignment(TD_LogoServer[1], 1);
	TextDrawColor(TD_LogoServer[1], 1130251775);
	TextDrawUseBox(TD_LogoServer[1], 1);
	TextDrawBoxColor(TD_LogoServer[1], -646184705);
	TextDrawBackgroundColor(TD_LogoServer[1], 255);
	TextDrawFont(TD_LogoServer[1], 1);
	TextDrawSetProportional(TD_LogoServer[1], 1);
	...
	TextDrawAlignment(TD_LogoServer[2], 2);
	TextDrawColor(TD_LogoServer[2], -437918721);
	TextDrawBackgroundColor(TD_LogoServer[2], 16);
	TextDrawFont(TD_LogoServer[2], 2);
	TextDrawSetProportional(TD_LogoServer[2], 1);
	...
	TextDrawAlignment(TD_BlackStripe[0], 1);
	TextDrawColor(TD_BlackStripe[0], -1);
	TextDrawUseBox(TD_BlackStripe[0], 1);
	TextDrawBoxColor(TD_BlackStripe[0], 255);
	TextDrawSetShadow(TD_BlackStripe[0], 0);
	TextDrawSetOutline(TD_BlackStripe[0], 0);
	TextDrawBackgroundColor(TD_BlackStripe[0], 255);
	TextDrawFont(TD_BlackStripe[0], 1);
	TextDrawSetProportional(TD_BlackStripe[0], 1);
	TextDrawSetShadow(TD_BlackStripe[0], 0);
	...
	TextDrawAlignment(TD_BlackStripe[1], 1);
	TextDrawColor(TD_BlackStripe[1], -1);
	TextDrawUseBox(TD_BlackStripe[1], 1);
	TextDrawBoxColor(TD_BlackStripe[1], 255);
	TextDrawSetShadow(TD_BlackStripe[1], 0);
	TextDrawSetOutline(TD_BlackStripe[1], 0);
	TextDrawBackgroundColor(TD_BlackStripe[1], 255);
	TextDrawFont(TD_BlackStripe[1], 1);
	TextDrawSetProportional(TD_BlackStripe[1], 1);
	TextDrawSetShadow(TD_BlackStripe[1], 0);
	...
	TextDrawAlignment(TD_BelowHealth[0], 1);
	TextDrawColor(TD_BelowHealth[0], 80);
	TextDrawUseBox(TD_BelowHealth[0], 1);
	TextDrawBoxColor(TD_BelowHealth[0], 48);
	TextDrawSetShadow(TD_BelowHealth[0], 0);
	TextDrawSetOutline(TD_BelowHealth[0], 0);
	TextDrawBackgroundColor(TD_BelowHealth[0], 255);
	TextDrawFont(TD_BelowHealth[0], 1);
	TextDrawSetProportional(TD_BelowHealth[0], 1);
	TextDrawSetShadow(TD_BelowHealth[0], 0);
	...
	TextDrawAlignment(TD_BelowHealth[1], 1);
	TextDrawColor(TD_BelowHealth[1], -1);
	TextDrawSetShadow(TD_BelowHealth[1], 0);
	TextDrawSetOutline(TD_BelowHealth[1], 0);
	TextDrawBackgroundColor(TD_BelowHealth[1], 255);
	TextDrawFont(TD_BelowHealth[1], 4);
	TextDrawSetProportional(TD_BelowHealth[1], 0);
	TextDrawSetShadow(TD_BelowHealth[1], 0);
	...
	TextDrawAlignment(TD_BelowHealth[2], 1);
	TextDrawColor(TD_BelowHealth[2], -1);
	TextDrawSetShadow(TD_BelowHealth[2], 0);
	TextDrawSetOutline(TD_BelowHealth[2], 0);
	TextDrawBackgroundColor(TD_BelowHealth[2], 255);
	TextDrawFont(TD_BelowHealth[2], 4);
	TextDrawSetProportional(TD_BelowHealth[2], 0);
	TextDrawSetShadow(TD_BelowHealth[2], 0);
	...
	TextDrawAlignment(TD_BelowHealth[3], 1);
	TextDrawColor(TD_BelowHealth[3], -1);
	TextDrawSetShadow(TD_BelowHealth[3], 0);
	TextDrawSetOutline(TD_BelowHealth[3], 0);
	TextDrawBackgroundColor(TD_BelowHealth[3], 255);
	TextDrawFont(TD_BelowHealth[3], 4);
	TextDrawSetProportional(TD_BelowHealth[3], 0);
	TextDrawSetShadow(TD_BelowHealth[3], 0);
	...
	TextDrawAlignment(TD_BelowHealth[4], 1);
	TextDrawColor(TD_BelowHealth[4], -1);
	TextDrawSetShadow(TD_BelowHealth[4], 0);
	TextDrawSetOutline(TD_BelowHealth[4], 0);
	TextDrawBackgroundColor(TD_BelowHealth[4], 255);
	TextDrawFont(TD_BelowHealth[4], 4);
	TextDrawSetProportional(TD_BelowHealth[4], 0);
	TextDrawSetShadow(TD_BelowHealth[4], 0);
	...
	TextDrawAlignment(TD_BelowHealth[5], 1);
	TextDrawColor(TD_BelowHealth[5], -1);
	TextDrawSetShadow(TD_BelowHealth[5], 0);
	TextDrawSetOutline(TD_BelowHealth[5], 0);
	TextDrawBackgroundColor(TD_BelowHealth[5], 255);
	TextDrawFont(TD_BelowHealth[5], 4);
	TextDrawSetProportional(TD_BelowHealth[5], 0);
	TextDrawSetShadow(TD_BelowHealth[5], 0);
	...
	TextDrawAlignment(TD_BelowHealth[6], 1);
	TextDrawColor(TD_BelowHealth[6], -1);
	TextDrawSetShadow(TD_BelowHealth[6], 0);
	TextDrawSetOutline(TD_BelowHealth[6], 0);
	TextDrawBackgroundColor(TD_BelowHealth[6], 255);
	TextDrawFont(TD_BelowHealth[6], 4);
	TextDrawSetProportional(TD_BelowHealth[6], 0);
	TextDrawSetShadow(TD_BelowHealth[6], 0);
	...
	TextDrawAlignment(TD_BelowHealth[7], 1);
	TextDrawColor(TD_BelowHealth[7], -1);
	TextDrawSetShadow(TD_BelowHealth[7], 0);
	TextDrawSetOutline(TD_BelowHealth[7], 0);
	TextDrawBackgroundColor(TD_BelowHealth[7], 255);
	TextDrawFont(TD_BelowHealth[7], 4);
	TextDrawSetProportional(TD_BelowHealth[7], 0);
	TextDrawSetShadow(TD_BelowHealth[7], 0);
...
stock DeaglePlayerAntiC(playerid)
{
	...
	switch(GetPlayerWeapon(playerid)) {
		case 24: {
			...
			TimerPlayerUnFreezeCW[playerid] = SetPlayerTimer(playerid, "UnfreezeCw", 500, 0);
		}
	}
	return 1;
}
...
stock ShowTDNewRank(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_NewRank[playerid], 2);
	PlayerTextDrawColor(playerid, TD_NewRank[playerid], -1);
	PlayerTextDrawSetShadow(playerid, TD_NewRank[playerid], 0);
	PlayerTextDrawSetOutline(playerid, TD_NewRank[playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_NewRank[playerid], 48);
	PlayerTextDrawFont(playerid, TD_NewRank[playerid], 2);
	PlayerTextDrawSetProportional(playerid, TD_NewRank[playerid], 1);
	PlayerTextDrawSetShadow(playerid, TD_NewRank[playerid], 0);
	return 1;
}
...
stock CreatePlayerTDs(playerid)
{
	...
	PlayerTextDrawBackgroundColor(playerid, TD, -2139062017);
...
stock TDRandomColor(playerid, PlayerText:td_id)
{
	...
	switch(r) {
		case 0: PlayerTextDrawColor(playerid, td_id, 0xff3030FF);
		case 1: PlayerTextDrawColor(playerid, td_id, 0x5630ffFF);
		case 2: PlayerTextDrawColor(playerid, td_id, 0x2ec8d9FF);
		case 3: PlayerTextDrawColor(playerid, td_id, 0x2ed947FF);
		case 4: PlayerTextDrawColor(playerid, td_id, 0x83d92eFF);
		case 5: PlayerTextDrawColor(playerid, td_id, 0xd9d92eFF);
		case 6: PlayerTextDrawColor(playerid, td_id, 0xa32ed9FF);
		case 7: PlayerTextDrawColor(playerid, td_id, 0x2e8cd9FF);
		case 8: PlayerTextDrawColor(playerid, td_id, 0x8cd92eFF);
		case 9: PlayerTextDrawColor(playerid, td_id, 0xd92e97FF);
		case 10: PlayerTextDrawColor(playerid, td_id, 0x2ed99dFF);
	}
...
stock ShowTDKillStrike(playerid) 
{
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerKillStrike[playerid], 2);
	PlayerTextDrawColor(playerid, TD_PlayerKillStrike[playerid], -653192773);
	PlayerTextDrawUseBox(playerid, TD_PlayerKillStrike[playerid], 1);
	PlayerTextDrawBoxColor(playerid, TD_PlayerKillStrike[playerid], 187);
	PlayerTextDrawSetShadow(playerid, TD_PlayerKillStrike[playerid], 0);
	PlayerTextDrawSetOutline(playerid, TD_PlayerKillStrike[playerid], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerKillStrike[playerid], 255);
	PlayerTextDrawFont(playerid, TD_PlayerKillStrike[playerid], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerKillStrike[playerid], 1);
	return 1;
}
...
stock ShowTDPlayerReward(playerid) 
{
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerReward[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_PlayerReward[playerid][0], -274973185);
	...
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerReward[playerid][0], 48);
	PlayerTextDrawFont(playerid, TD_PlayerReward[playerid][0], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerReward[playerid][0], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerReward[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_PlayerReward[playerid][1], 1575768575);
	...
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerReward[playerid][1], 48);
	PlayerTextDrawFont(playerid, TD_PlayerReward[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerReward[playerid][1], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerReward[playerid][2], 1);
	PlayerTextDrawColor(playerid, TD_PlayerReward[playerid][2], -219147265);
	...
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerReward[playerid][2], 48);
	PlayerTextDrawFont(playerid, TD_PlayerReward[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerReward[playerid][2], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerReward[playerid][3], 1);
	PlayerTextDrawColor(playerid, TD_PlayerReward[playerid][3], -219147265);
	...
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerReward[playerid][3], 48);
	PlayerTextDrawFont(playerid, TD_PlayerReward[playerid][3], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerReward[playerid][3], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerReward[playerid][4], 1);
	PlayerTextDrawColor(playerid, TD_PlayerReward[playerid][4], -219147265);
	...
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerReward[playerid][4], 48);
	PlayerTextDrawFont(playerid, TD_PlayerReward[playerid][4], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerReward[playerid][4], 1);
	return 1;
}
...
stock ShowTDPlayerStatsRound(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerStatsRound[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_PlayerStatsRound[playerid][0], -34978049);
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerStatsRound[playerid][0], 153);
	PlayerTextDrawFont(playerid, TD_PlayerStatsRound[playerid][0], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerStatsRound[playerid][0], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerStatsRound[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_PlayerStatsRound[playerid][1], 2121985279);
	PlayerTextDrawSetShadow(playerid, TD_PlayerStatsRound[playerid][1], 1);
	PlayerTextDrawSetOutline(playerid, TD_PlayerStatsRound[playerid][1], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerStatsRound[playerid][1], 153);
	PlayerTextDrawFont(playerid, TD_PlayerStatsRound[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerStatsRound[playerid][1], 1);
	str[0] = EOS;
	...
	PlayerTextDrawAlignment(playerid, TD_PlayerStatsRound[playerid][2], 1);
	PlayerTextDrawColor(playerid, TD_PlayerStatsRound[playerid][2], -327254273);
	PlayerTextDrawSetShadow(playerid, TD_PlayerStatsRound[playerid][2], 1);
	PlayerTextDrawSetOutline(playerid, TD_PlayerStatsRound[playerid][2], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_PlayerStatsRound[playerid][2], 153);
	PlayerTextDrawFont(playerid, TD_PlayerStatsRound[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_PlayerStatsRound[playerid][2], 1);
	return 1;
}
...
stock ShowTDPlayerFPSandPING(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_FPS_and_PING[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_FPS_and_PING[playerid][0], -1);
	PlayerTextDrawUseBox(playerid, TD_FPS_and_PING[playerid][0], 1);
	PlayerTextDrawBoxColor(playerid, TD_FPS_and_PING[playerid][0], 0x00000000); // 153
	PlayerTextDrawBackgroundColor(playerid, TD_FPS_and_PING[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_FPS_and_PING[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, TD_FPS_and_PING[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, TD_FPS_and_PING[playerid][0], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_FPS_and_PING[playerid][1], 3);
	PlayerTextDrawColor(playerid, TD_FPS_and_PING[playerid][1], -960051969);
	PlayerTextDrawSetShadow(playerid, TD_FPS_and_PING[playerid][1], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_FPS_and_PING[playerid][1], 128);
	PlayerTextDrawFont(playerid, TD_FPS_and_PING[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, TD_FPS_and_PING[playerid][1], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_FPS_and_PING[playerid][2], 1);
	PlayerTextDrawColor(playerid, TD_FPS_and_PING[playerid][2], -960051969);
	PlayerTextDrawSetShadow(playerid, TD_FPS_and_PING[playerid][2], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_FPS_and_PING[playerid][2], 128);
	PlayerTextDrawFont(playerid, TD_FPS_and_PING[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_FPS_and_PING[playerid][2], 1);
	return 1;
}
...
stock ShowTDSpawnKill(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_TimerSpawnKill[playerid], 2);
	PlayerTextDrawColor(playerid, TD_TimerSpawnKill[playerid], -1);
	PlayerTextDrawSetShadow(playerid, TD_TimerSpawnKill[playerid], 1);
	PlayerTextDrawSetOutline(playerid, TD_TimerSpawnKill[playerid], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_TimerSpawnKill[playerid], 80);
	PlayerTextDrawFont(playerid, TD_TimerSpawnKill[playerid], 2);
	PlayerTextDrawSetProportional(playerid, TD_TimerSpawnKill[playerid], 1);
	PlayerTextDrawSetShadow(playerid, TD_TimerSpawnKill[playerid], 1);
	return 1;
}
...
stock ShowPlayerTDExitZone(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_ExitZone[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_ExitZone[playerid][0], -1);
	PlayerTextDrawUseBox(playerid, TD_ExitZone[playerid][0], 1);
	PlayerTextDrawBoxColor(playerid, TD_ExitZone[playerid][0], 80);
	PlayerTextDrawBackgroundColor(playerid, TD_ExitZone[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_ExitZone[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, TD_ExitZone[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, TD_ExitZone[playerid][0], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_ExitZone[playerid][1], 2);
	PlayerTextDrawColor(playerid, TD_ExitZone[playerid][1], -1136573953);
	PlayerTextDrawSetOutline(playerid, TD_ExitZone[playerid][1], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_ExitZone[playerid][1], 21);
	PlayerTextDrawFont(playerid, TD_ExitZone[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, TD_ExitZone[playerid][1], 1);
	PlayerTextDrawSetShadow(playerid, TD_ExitZone[playerid][1], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_ExitZone[playerid][2], 2);
	PlayerTextDrawColor(playerid, TD_ExitZone[playerid][2], -1339019009);
	PlayerTextDrawSetOutline(playerid, TD_ExitZone[playerid][2], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_ExitZone[playerid][2], 32);
	PlayerTextDrawFont(playerid, TD_ExitZone[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_ExitZone[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, TD_ExitZone[playerid][2], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_ExitZone[playerid][3], 2);
	PlayerTextDrawColor(playerid, TD_ExitZone[playerid][3], -1037621249);
	PlayerTextDrawSetOutline(playerid, TD_ExitZone[playerid][3], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_ExitZone[playerid][3], 32);
	PlayerTextDrawFont(playerid, TD_ExitZone[playerid][3], 2);
	PlayerTextDrawSetProportional(playerid, TD_ExitZone[playerid][3], 1);
	PlayerTextDrawSetShadow(playerid, TD_ExitZone[playerid][3], 0);

	TD_ExitZone[playerid][4] = CreatePlayerTextDraw(playerid, 311.0000, 237.0000, "");
	PlayerTextDrawTextSize(playerid, TD_ExitZone[playerid][4], 15.0000, 13.0000);
	PlayerTextDrawAlignment(playerid, TD_ExitZone[playerid][4], 1);
	PlayerTextDrawColor(playerid, TD_ExitZone[playerid][4], -579241473);
	PlayerTextDrawFont(playerid, TD_ExitZone[playerid][4], 5);
	PlayerTextDrawBackgroundColor(playerid, TD_ExitZone[playerid][4], 0x00000000);
	PlayerTextDrawSetProportional(playerid, TD_ExitZone[playerid][4], 0);
	PlayerTextDrawSetShadow(playerid, TD_ExitZone[playerid][4], 0);
...
stock UpdateTDDeadKiller(playerid, killerid)
{
	...
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][1], GetPlayerColorEx(killerid));
	str[0] = EOS;
	...
	PlayerTextDrawSetPreviewModel(playerid, TD_DeadKiller[playerid][12], GetWeaponModel(GetPlayerWeapon(killerid)));

	if(GetWeaponModel(GetPlayerWeapon(killerid)) != -1) 
...
stock ShowTDDeadKiller(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][0], -1);
	PlayerTextDrawUseBox(playerid, TD_DeadKiller[playerid][0], 1);
	PlayerTextDrawBoxColor(playerid, TD_DeadKiller[playerid][0], -620362002);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][0], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][1], -488447745);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][1], 128);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][1], 1);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][1], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][2], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][2], -1);
	PlayerTextDrawUseBox(playerid, TD_DeadKiller[playerid][2], 1);
	PlayerTextDrawBoxColor(playerid, TD_DeadKiller[playerid][2], 1145194478);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][2], 255);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][2], 1);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][2], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][3], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][3], -690563841);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][3], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][3], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][3], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][3], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][4], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][4], -651745281);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][4], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][4], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][4], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][4], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][5], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][5], -690563841);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][5], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][5], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][5], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][5], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][6], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][6], 1168234239);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][6], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][6], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][6], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][6], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][7], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][7], -1);
	PlayerTextDrawUseBox(playerid, TD_DeadKiller[playerid][7], 1);
	PlayerTextDrawBoxColor(playerid, TD_DeadKiller[playerid][7], 1145194478);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][7], 255);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][7], 1);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][7], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][7], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][8], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][8], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][8], 255);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][8], 4);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][8], 0);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][8], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][9], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][9], -690563841);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][9], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][9], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][9], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][9], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][10], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][10], -35964161);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][10], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][10], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][10], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][10], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][11], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][11], -1);
	PlayerTextDrawUseBox(playerid, TD_DeadKiller[playerid][11], 1);
	PlayerTextDrawBoxColor(playerid, TD_DeadKiller[playerid][11], 1145194478);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][11], 255);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][11], 1);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][11], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][11], 0);

	TD_DeadKiller[playerid][12] = CreatePlayerTextDraw(playerid, 316.0000, 382.0000, ""); // Объект оружия
	PlayerTextDrawTextSize(playerid, TD_DeadKiller[playerid][12], 70.0000, 47.0000);
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][12], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][12], -1);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][12], 5);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][12], 0);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][12], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][12], 0x00000000);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][13], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][13], -690563841);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][13], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][13], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][13], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][13], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][14], 1);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][14], -1);
	PlayerTextDrawUseBox(playerid, TD_DeadKiller[playerid][14], 1);
	PlayerTextDrawBoxColor(playerid, TD_DeadKiller[playerid][14], 1145194478);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][14], 255);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][14], 1);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][14], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][14], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][15], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][15], -690563841);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][15], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][15], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][15], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][15], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_DeadKiller[playerid][16], 2);
	PlayerTextDrawColor(playerid, TD_DeadKiller[playerid][16], -692027393);
	PlayerTextDrawBackgroundColor(playerid, TD_DeadKiller[playerid][16], 16);
	PlayerTextDrawFont(playerid, TD_DeadKiller[playerid][16], 2);
	PlayerTextDrawSetProportional(playerid, TD_DeadKiller[playerid][16], 1);
	PlayerTextDrawSetShadow(playerid, TD_DeadKiller[playerid][16], 0);

	Bar_time_to_spawn[playerid] = CreatePlayerProgressBar(playerid, 243.00, 418.00, 55.50, 6.19, 0xff0000FF, Mode_GetModeTimeRespawn(Mode_GetPlayer(playerid)), BAR_DIRECTION_RIGHT, 0xc4c4c4FF);
	HidePlayerProgressBar(playerid, Bar_time_to_spawn[playerid]);
	return 1;
}
...
stock ShowTDDeath(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_Dead[playerid], 2);
	PlayerTextDrawColor(playerid, TD_Dead[playerid], -534633729);
	PlayerTextDrawSetOutline(playerid, TD_Dead[playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, TD_Dead[playerid], 255);
	PlayerTextDrawFont(playerid, TD_Dead[playerid], 2);
	PlayerTextDrawSetProportional(playerid, TD_Dead[playerid], 1);
