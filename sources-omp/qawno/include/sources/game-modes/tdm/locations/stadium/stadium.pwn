...
stock TDM_Stadium_CreateElements(session_id)
{
	...
	// Лучшие игроки
	TDM_SetSpawnTopActor(session_id, 0, 1389.1769, 2142.0859, 11.0234, 91.1574);
	TDM_SetSpawnTopActor(session_id, 1, 1391.0818, 2143.8198, 11.0234, 91.1574);
	TDM_SetSpawnTopActor(session_id, 2, 1391.7516, 2140.6196, 11.0234, 91.1574);
	TDM_SetSpawnTopActor(session_id, 3, 1391.9286, 2146.7500, 11.0234, 91.1574);
	TDM_SetSpawnTopActor(session_id, 4, 1392.5710, 2137.8098, 11.0234, 91.1574);
