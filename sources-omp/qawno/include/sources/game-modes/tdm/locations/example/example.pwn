...
stock TDM_Example_CreateElements(session_id)
{
	...
	// Лучшие игроки
	TDM_SetSpawnTopActor(session_id, 0, 1885.3085, -2388.3430, 13.5547, 269.9020);
	TDM_SetSpawnTopActor(session_id, 1, 1883.6346, -2389.4019, 13.5547, 269.5493);
	TDM_SetSpawnTopActor(session_id, 2, 1881.6953, -2386.3438, 13.5547, 270.1133);
	TDM_SetSpawnTopActor(session_id, 3, 1878.8070, -2390.8601, 13.5547, 268.9854);
	TDM_SetSpawnTopActor(session_id, 4, 1877.7831, -2384.6487, 13.5547, 272.3694);
