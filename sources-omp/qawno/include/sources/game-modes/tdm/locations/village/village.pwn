...
stock TDM_Village_CreateElements(session_id)
{
	...
	// Лучшие игроки
	TDM_SetSpawnTopActor(session_id, 0, -2402.1113, 2332.4780, 4.9844, 12.5336);
	TDM_SetSpawnTopActor(session_id, 1, -2399.1506, 2331.9771, 4.9844, 13.4735);
	TDM_SetSpawnTopActor(session_id, 2, -2403.5195, 2329.9368, 4.9844, 11.5935);
	TDM_SetSpawnTopActor(session_id, 3, -2395.7351, 2329.8364, 4.9844, 13.7869);
	TDM_SetSpawnTopActor(session_id, 4, -2403.7979, 2328.9851, 4.9844, 16.6069);
