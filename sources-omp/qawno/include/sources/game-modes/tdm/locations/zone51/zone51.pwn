...
stock TDM_Zone51_CreateElements(session_id)
{
	...
	// Лучшие игроки
	TDM_SetSpawnTopActor(session_id, 0, 213.4783, 1905.8370, 17.6406, 356.2400);
	TDM_SetSpawnTopActor(session_id, 1, 216.2217, 1904.3049, 17.6406, 356.2400);
	TDM_SetSpawnTopActor(session_id, 2, 210.2355, 1904.0776, 17.6406, 356.2400);
	TDM_SetSpawnTopActor(session_id, 3, 217.5923, 1902.1473, 17.6406, 359.0601);
	TDM_SetSpawnTopActor(session_id, 4, 209.7822, 1902.2002, 17.6406, 359.0601);
