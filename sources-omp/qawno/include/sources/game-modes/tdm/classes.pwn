...
static ShowInfoClass(playerid)
{
	...
	PlayerTextDrawSetString(playerid, TD_cSelectedClass[playerid][2], TDM_GetClassName(class_id));
	...
	for(new i = 9, w = 0; w < TDM_CLASS_MAX_WEAPONS; i++, w++) 
		PlayerTextDrawSetPreviewModel(playerid, TD_cSelectedClass[playerid][i], GetWeaponModelEx(PlayerCWeapon[playerid][CW_Weapon][class_id][w]));
...
static ShowInfoWeapon(playerid)
{
	...
	for(new td = 3, c = 0; c < TDM_CLASS_MAX_WEAPON_SLOTS; td++, c++) {
		if(weapon[c] != 0) {
			PlayerTextDrawSetPreviewModel(playerid, TD_cSelectWeapon[playerid][td], GetWeaponModelEx(weapon[c]));
			...
			if(PlayerClass[playerid][cKills][class_id] < ClassesWeaponPrice[class_id][slot][c]) {
				...
				PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][td + 3], -79740929);
			}
			else {
				new
				...
				PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][td + 3], -505290753);
			}
			...
			if(PlayerCWeapon[playerid][CW_Weapon][class_id][slot] == weapon[c]) 
				PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][td - 3], 0x3cba40FF);
			else 
				PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][td - 3], -1717986817);
		}
		else {
	...
	switch(type) {
		...
		case 1: {
			...
			if(PlayerBody[playerid][B_Cap][class_id] == 0) 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][0], 0x3cba40FF);
			else 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][0], -1717986817);

			if(PlayerBody[playerid][B_Cap][class_id] == 1) 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][1], 0x3cba40FF);
			else 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][1], -1717986817);

			if(PlayerBody[playerid][B_Cap][class_id] == 2) 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][2], 0x3cba40FF);
			else 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][2], -1717986817);

			if(PlayerBody[playerid][B_Cap][class_id] == 3) 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][3], 0x3cba40FF);
			else 
				PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][3], -1717986817);
		}
		// Бронежилет
		case 2: {
...
{
	// Задний белый фон 
	TD_cSelectWeapon[playerid][0] = CreatePlayerTextDraw(playerid, 190.0000, 191.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][0], 80.0000, 69.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][0], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][0], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][0], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][0], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][0], false);
	...
	// Задний белый фон 2
	TD_cSelectWeapon[playerid][1] = CreatePlayerTextDraw(playerid, 273.0000, 191.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][1], 80.0000, 69.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][1], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][1], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][1], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][1], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][1], false);
	...
	// Задний белый фон 3
	TD_cSelectWeapon[playerid][2] = CreatePlayerTextDraw(playerid, 356.0000, 191.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][2], 80.0000, 69.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][2], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][2], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][2], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][2], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][2], false);
	...
	// Задний чёрный фон 1
	TD_cSelectWeapon[playerid][3] = CreatePlayerTextDraw(playerid, 191.0000, 192.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][3], 78.0000, 67.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][3], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][3], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][3], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][3], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][3], false);
	...
	// Задний чёрный фон 2
	TD_cSelectWeapon[playerid][4] = CreatePlayerTextDraw(playerid, 274.0000, 192.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][4], 78.0000, 67.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][4], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][4], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][4], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][4], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][4], false);
	...
	// Задний чёрный фон 3
	TD_cSelectWeapon[playerid][5] = CreatePlayerTextDraw(playerid, 357.0000, 192.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][5], 78.0000, 67.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][5], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][5], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][5], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][5], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][5], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][6], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][6], -505290753);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][6], 255);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][6], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][6], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][7], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][7], -79740929);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][7], 255);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][7], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][7], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][8], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][8], -79740929);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][8], 255);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][8], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][8], true);
	PlayerTextDrawSetShadow(playerid, TD_cSelectWeapon[playerid][8], 0);

	// Задний чёрный фон выбор
	TD_cSelectWeapon[playerid][9] = CreatePlayerTextDraw(playerid, 190.0000, 170.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][9], 246.0000, 18.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][9], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][9], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][9], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][9], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][9], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][10], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][10], -909522945);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][10], 255);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][10], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][10], true);
	PlayerTextDrawSetShadow(playerid, TD_cSelectWeapon[playerid][10], 0);

	// Задний чёрный фон убийств
	TD_cSelectWeapon[playerid][11] = CreatePlayerTextDraw(playerid, 190.0000, 263.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][11], 246.0000, 18.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][11], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][11], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][11], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][11], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][11], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][12], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][12], 919041791);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][12], -952879873);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][12], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][12], true);
	PlayerTextDrawSetShadow(playerid, TD_cSelectWeapon[playerid][12], 0);

	// Задний белый фон назад
	TD_cSelectWeapon[playerid][13] = CreatePlayerTextDraw(playerid, 190.0000, 284.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][13], 43.0000, 18.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][13], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][13], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][13], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][13], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][13], false);
	...
	TD_cSelectWeapon[playerid][14] = CreatePlayerTextDraw(playerid, 191.0000, 285.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectWeapon[playerid][14], 41.0000, 16.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][14], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][14], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][14], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][14], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][14], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectWeapon[playerid][15], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectWeapon[playerid][15], -952879873);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectWeapon[playerid][15], -952879873);
	PlayerTextDrawFont(playerid, TD_cSelectWeapon[playerid][15], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetSelectable(playerid, TD_cSelectWeapon[playerid][15], true);
	PlayerTextDrawSetProportional(playerid, TD_cSelectWeapon[playerid][15], true);
...
static TDM_ShowPlayerTDSelectClass(playerid)
{
	...
	// Задний белый фон
	TD_cSelectClass[playerid][0] = CreatePlayerTextDraw(playerid, 158.0000, 176.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][0], 77.0000, 104.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][0], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][0], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][0], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][0], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][0], false);
	...
	// Задний белый фон
	TD_cSelectClass[playerid][1] = CreatePlayerTextDraw(playerid, 238.0000, 176.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][1], 77.0000, 104.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][1], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][1], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][1], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][1], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][1], false);
	...
	// Задний белый фон
	TD_cSelectClass[playerid][2] = CreatePlayerTextDraw(playerid, 318.0000, 176.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][2], 77.0000, 104.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][2], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][2], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][2], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][2], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][2], false);
	...
	// Задний белый фон
	TD_cSelectClass[playerid][3] = CreatePlayerTextDraw(playerid, 398.0000, 176.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][3], 77.0000, 104.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][3], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][3], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][3], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][3], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][3], false);
	...
	// Задний чёрный фон
	TD_cSelectClass[playerid][4] = CreatePlayerTextDraw(playerid, 159.0000, 177.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][4], 75.0000, 102.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][4], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][4], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][4], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][4], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][4], false);
	...
	// Задний чёрный фон
	TD_cSelectClass[playerid][5] = CreatePlayerTextDraw(playerid, 239.0000, 177.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][5], 75.0000, 102.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][5], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][5], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][5], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][5], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][5], false);
	...
	// Задний чёрный фон
	TD_cSelectClass[playerid][6] = CreatePlayerTextDraw(playerid, 319.0000, 177.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][6], 75.0000, 102.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][6], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][6], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][6], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][6], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][6], false);
	...
	// Задний чёрный фон
	TD_cSelectClass[playerid][7] = CreatePlayerTextDraw(playerid, 399.0000, 177.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][7], 75.0000, 102.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][7], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][7], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][7], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][7], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][7], false);
	...
	TD_cSelectClass[playerid][8] = CreatePlayerTextDraw(playerid, 158.0000, 158.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][8], 317.0000, 15.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][8], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][8], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][8], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][8], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][8], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][9], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][9], -33686529);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][9], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][9], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][9], true);
	PlayerTextDrawSetShadow(playerid, TD_cSelectClass[playerid][9], 0);

	// Задний белый фон назад
	TD_cSelectClass[playerid][10] = CreatePlayerTextDraw(playerid, 158.0000, 282.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][10], 53.0000, 20.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][10], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][10], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][10], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][10], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][10], false);
	...
	// Задний чёрный фон назад
	TD_cSelectClass[playerid][11] = CreatePlayerTextDraw(playerid, 159.0000, 283.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectClass[playerid][11], 51.0000, 18.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][11], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][11], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][11], 589505535);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][11], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][11], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][12], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][12], -1003277313);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][12], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][12], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][12], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][13], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][13], -690563841);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][13], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][13], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][13], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][14], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][14], -690563841);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][14], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][14], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][14], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][15], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][15], -690563841);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][15], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][15], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][15], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][16], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][16], -690563841);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][16], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][16], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][16], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][17], TEXT_DRAW_ALIGN_RIGHT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][17], -1108345857);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][17], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][17], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][17], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][18], TEXT_DRAW_ALIGN_RIGHT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][18], -1108345857);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][18], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][18], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][18], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][19], TEXT_DRAW_ALIGN_RIGHT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][19], -1108345857);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][19], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][19], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][19], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectClass[playerid][20], TEXT_DRAW_ALIGN_RIGHT);
	PlayerTextDrawColour(playerid, TD_cSelectClass[playerid][20], -1108345857);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectClass[playerid][20], 255);
	PlayerTextDrawFont(playerid, TD_cSelectClass[playerid][20], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectClass[playerid][20], true);
...
{
	// Задний белый фон
	TD_cSelectedClass[playerid][0] = CreatePlayerTextDraw(playerid, 271.0000, 131.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][0], 100.0000, 108.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][0], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][0], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][0], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][0], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][0], false);
	...
	// Задний чёрный фон
	TD_cSelectedClass[playerid][1] = CreatePlayerTextDraw(playerid, 272.0000, 132.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][1], 98.0000, 106.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][1], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][1], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][1], 303174399);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][1], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][1], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][2], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][2], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][2], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][2], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][2], true);
	PlayerTextDrawSetShadow(playerid, TD_cSelectedClass[playerid][2], 0);

	// Задний зелёный фон шлем
	TD_cSelectedClass[playerid][3] = CreatePlayerTextDraw(playerid, 374.0000, 131.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][3], 26.0000, 29.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][3], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][3], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][3], -2136582657);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][3], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][3], false);
	...
	TD_cSelectedClass[playerid][4] = CreatePlayerTextDraw(playerid, 375.0000, 132.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][4], 24.0000, 27.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][4], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][4], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][4], 303174399);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][4], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][4], false);
	...
	TD_cSelectedClass[playerid][5] = CreatePlayerTextDraw(playerid, 374.0000, 163.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][5], 26.0000, 29.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][5], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][5], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][5], -2136582657);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][5], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][5], false);
	...
	TD_cSelectedClass[playerid][6] = CreatePlayerTextDraw(playerid, 375.0000, 164.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][6], 24.0000, 27.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][6], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][6], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][6], 303174399);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][6], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][6], false);
	...
	TD_cSelectedClass[playerid][7] = CreatePlayerTextDraw(playerid, 271.0000, 242.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][7], 100.0000, 52.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][7], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][7], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][7], -1500686849);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][7], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][7], false);
	...
	TD_cSelectedClass[playerid][8] = CreatePlayerTextDraw(playerid, 272.0000, 243.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][8], 98.0000, 50.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][8], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][8], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][8], 303174399);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][8], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][8], false);
	...
	// Оружие 1
	TD_cSelectedClass[playerid][9] = CreatePlayerTextDraw(playerid, 274.0000, 245.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][9], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][9], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][9], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][9], -1466330369);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][9], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][9], false);
	...
	// Оружие 2
	TD_cSelectedClass[playerid][10] = CreatePlayerTextDraw(playerid, 298.0000, 245.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][10], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][10], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][10], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][10], -1466330369);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][10], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][10], false);
	...
	// Оружие 3
	TD_cSelectedClass[playerid][11] = CreatePlayerTextDraw(playerid, 322.0000, 245.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][11], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][11], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][11], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][11], -1466330369);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][11], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][11], false);
	...
	// Оружие 4
	TD_cSelectedClass[playerid][12] = CreatePlayerTextDraw(playerid, 346.0000, 245.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][12], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][12], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][12], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][12], -1466330369);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][12], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][12], false);
	...
	// Патроны 1
	TD_cSelectedClass[playerid][13] = CreatePlayerTextDraw(playerid, 274.0000, 269.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][13], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][13], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][13], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][13], -1367909889);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][13], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][13], false);
	...
	// Патроны 2
	TD_cSelectedClass[playerid][14] = CreatePlayerTextDraw(playerid, 298.0000, 269.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][14], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][14], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][14], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][14], -1367909889);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][14], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][14], false);
	...
	// Патроны 3
	TD_cSelectedClass[playerid][15] = CreatePlayerTextDraw(playerid, 322.0000, 269.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][15], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][15], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][15], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][15], -1367909889);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][15], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][15], false);
	...
	// Патроны 4
	TD_cSelectedClass[playerid][16] = CreatePlayerTextDraw(playerid, 346.0000, 269.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][16], 22.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][16], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][16], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][16], -1367909889);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][16], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][16], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][17], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][17], -320017665);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][17], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][17], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][17], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][18], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][18], -320017665);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][18], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][18], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][18], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][19], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][19], -320017665);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][19], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][19], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][19], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][20], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][20], -320017665);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][20], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][20], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][20], true);
	PlayerTextDrawSetShadow(playerid, TD_cSelectedClass[playerid][20], 0);

	// Задний белый фон назад
	TD_cSelectedClass[playerid][21] = CreatePlayerTextDraw(playerid, 271.0000, 297.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][21], 49.0000, 19.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][21], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][21], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][21], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][21], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][21], false);
	...
	// Задний чёрный фон назад
	TD_cSelectedClass[playerid][22] = CreatePlayerTextDraw(playerid, 272.0000, 298.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][22], 47.0000, 17.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][22], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][22], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][22], 303174399);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][22], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][22], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][23], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][23], -63621633);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][23], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][23], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][23], true);
	...
	TD_cSelectedClass[playerid][24] = CreatePlayerTextDraw(playerid, 322.0000, 297.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][24], 49.0000, 19.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][24], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][24], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][24], -1717986817);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][24], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][24], false);
	...
	TD_cSelectedClass[playerid][25] = CreatePlayerTextDraw(playerid, 323.0000, 298.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cSelectedClass[playerid][25], 47.0000, 17.0000);
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][25], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][25], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][25], 303174399);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][25], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][25], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cSelectedClass[playerid][26], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cSelectedClass[playerid][26], -55888385);
	PlayerTextDrawBackgroundColour(playerid, TD_cSelectedClass[playerid][26], 255);
	PlayerTextDrawFont(playerid, TD_cSelectedClass[playerid][26], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetSelectable(playerid, TD_cSelectedClass[playerid][26], true);
	PlayerTextDrawSetProportional(playerid, TD_cSelectedClass[playerid][26], true);
...
{
	// Задний белый фон 1
	TD_cBuy[playerid][0] = CreatePlayerTextDraw(playerid, 170.0000, 201.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][0], 70.0000, 66.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][0], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][0], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][0], -1717986817);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][0], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][0], false);
	...
	// Задний белый фон 2
	TD_cBuy[playerid][1] = CreatePlayerTextDraw(playerid, 243.0000, 201.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][1], 70.0000, 66.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][1], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][1], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][1], -1717986817);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][1], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][1], false);
	...
	// Задний белый фон 3
	TD_cBuy[playerid][2] = CreatePlayerTextDraw(playerid, 316.0000, 201.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][2], 70.0000, 66.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][2], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][2], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][2], -1717986817);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][2], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][2], false);
	...
	// Задний белый фон 4
	TD_cBuy[playerid][3] = CreatePlayerTextDraw(playerid, 389.0000, 201.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][3], 70.0000, 66.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][3], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][3], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][3], -1717986817);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][3], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][3], false);
	...
	// Задний чёрный фон 1
	TD_cBuy[playerid][4] = CreatePlayerTextDraw(playerid, 171.0000, 202.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][4], 68.0000, 64.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][4], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][4], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][4], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][4], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][4], false);
	...
	// Задний чёрный фон 2
	TD_cBuy[playerid][5] = CreatePlayerTextDraw(playerid, 244.0000, 202.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][5], 68.0000, 64.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][5], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][5], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][5], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][5], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][5], false);
	...
	// Задний чёрный фон 3
	TD_cBuy[playerid][6] = CreatePlayerTextDraw(playerid, 317.0000, 202.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][6], 68.0000, 64.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][6], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][6], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][6], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][6], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][6], false);
	...
	// Задний чёрный фон 4
	TD_cBuy[playerid][7] = CreatePlayerTextDraw(playerid, 390.0000, 202.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][7], 68.0000, 64.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][7], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][7], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][7], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][7], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][7], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][8], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][8], -656877825);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][8], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][8], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][8], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][9], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][9], -656877825);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][9], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][9], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][9], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][10], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][10], -656877825);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][10], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][10], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][10], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][11], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][11], -656877825);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][11], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][11], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][11], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][12], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][12], -651613697);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][12], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][12], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][12], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][13], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][13], -651613697);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][13], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][13], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][13], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][14], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][14], -651613697);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][14], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][14], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][14], true);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][15], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][15], -651613697);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][15], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][15], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][15], true);
	PlayerTextDrawSetShadow(playerid, TD_cBuy[playerid][15], 0);

	// Задний чёрный фон выбора
	TD_cBuy[playerid][16] = CreatePlayerTextDraw(playerid, 170.0000, 184.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][16], 289.0000, 14.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][16], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][16], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][16], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][16], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][16], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][17], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][17], -741092865);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][17], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][17], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][17], true);
	PlayerTextDrawSetShadow(playerid, TD_cBuy[playerid][17], 0);

	// Задний чёрный фон кредитов
	TD_cBuy[playerid][18] = CreatePlayerTextDraw(playerid, 170.0000, 270.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][18], 289.0000, 15.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][18], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][18], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][18], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][18], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][18], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][19], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][19], 952579071);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][19], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][19], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][19], true);
	PlayerTextDrawSetShadow(playerid, TD_cBuy[playerid][19], 0);

	// Задний белый фон назад
	TD_cBuy[playerid][20] = CreatePlayerTextDraw(playerid, 170.0000, 288.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][20], 42.0000, 17.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][20], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][20], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][20], -1717986817);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][20], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][20], false);
	...
	// Задний чёрный фон назад
	TD_cBuy[playerid][21] = CreatePlayerTextDraw(playerid, 171.0000, 289.0000, "_");
	PlayerTextDrawTextSize(playerid, TD_cBuy[playerid][21], 40.0000, 15.0000);
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][21], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][21], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][21], 589505535);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][21], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][21], false);
	...
	PlayerTextDrawAlignment(playerid, TD_cBuy[playerid][22], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_cBuy[playerid][22], -952945409);
	PlayerTextDrawBackgroundColour(playerid, TD_cBuy[playerid][22], 255);
	PlayerTextDrawFont(playerid, TD_cBuy[playerid][22], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_cBuy[playerid][22], true);
