...
stock Room_UpdateTD(playerid, room_id)
{
	...
	for(new m = 0, td = 20, num = 1; m < RoomInfo[room_id][R_NumberPlayers]; m++, num++, td += 4) {
		...
		if(cell > -1) {
			...
			PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][td], 690563583);
			...
			PlayerTextDrawColour(playerid, TD_Room[playerid][td + 1], -741092865);

			f(str, "Ранг: %i", GetPlayerRank(p));
			PlayerTextDrawSetString(playerid, TD_Room[playerid][td + 2], str);
			PlayerTextDrawColour(playerid, TD_Room[playerid][td + 2], -625128449);

			PlayerTextDrawColour(playerid, TD_Room[playerid][td + 3], -741092865);

			for(new i = td; i < td + 4; i++) 
				PlayerTextDrawShow(playerid, TD_Room[playerid][i]);
		}
		else {
			PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][td], 0x00000000);
			...
			PlayerTextDrawColour(playerid, TD_Room[playerid][td + 3], 0x00000000);
...
static Room_CreateTDTeamChet(playerid, td_id = -1, td_one_id = -1, team_id, maxchet)
{
	...
	if(td_one_id != -1) {
		switch(td_one_id) {
			case 0: {
				...
				PlayerTextDrawColour(playerid, TD_ChetLocation[playerid][0], Room_ShowTeamColorXB(team_id));
	...
	if(td_id != -1) {
		switch(td_id) {
			case 0: {
				PlayerChetLocation[playerid][0] = CreatePlayerProgressBar(playerid, 233.00, 43.00, 84.50, 5.19, Room_ShowTeamColorXB(team_id), maxchet, BAR_DIRECTION_LEFT);
			...
			case 1: {
				...
				PlayerTextDrawColour(playerid, TD_ChetLocation[playerid][2], Room_ShowTeamColorXB(team_id));
...
static Room_ShowTD(playerid, room_id)
{
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][0], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][0], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_Room[playerid][0], 1);
	PlayerTextDrawBoxColour(playerid, TD_Room[playerid][0], 1162167807);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][0], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][0], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][1], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][1], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_Room[playerid][1], 1);
	PlayerTextDrawBoxColour(playerid, TD_Room[playerid][1], 606348543);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][1], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][1], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][1], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][2], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][2], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_Room[playerid][2], 1);
	PlayerTextDrawBoxColour(playerid, TD_Room[playerid][2], 808464639);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][2], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][2], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][2], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][3], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][3], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_Room[playerid][3], 1);
	PlayerTextDrawBoxColour(playerid, TD_Room[playerid][3], 808464639);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][3], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][3], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][3], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][4], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][4], -505290753);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][4], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][4], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][4], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][5], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][5], 1079894015);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][5], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][5], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][5], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][6], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][6], -547660801);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][6], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][6], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][6], true);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][7], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][7], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][7], 255);
	PlayerTextDrawFont(playerid, TD_Room[playerid][7], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][7], true);
	PlayerTextDrawSetShadow(playerid, TD_Room[playerid][7], 0);

	// Белый фон выхода
	TD_Room[playerid][8] = CreatePlayerTextDraw(playerid, 194.0000, 347.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][8], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][8], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][8], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][8], -1717986817);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][8], false);
	...
	// Чёрный фон выхода
	TD_Room[playerid][9] = CreatePlayerTextDraw(playerid, 195.0000, 348.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][9], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][9], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][9], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][9], 303174399);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][9], false);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][10], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][10], -76911105);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][10], -1);
	PlayerTextDrawFont(playerid, TD_Room[playerid][10], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][10], true);
	PlayerTextDrawSetShadow(playerid, TD_Room[playerid][10], 0);
	PlayerTextDrawSetSelectable(playerid, TD_Room[playerid][10], true);

	// Белый фон инфо
	TD_Room[playerid][11] = CreatePlayerTextDraw(playerid, 242.0000, 347.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][11], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][11], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][11], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][11], -1717986817);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][11], false);
	...
	// Чёрный фон ифно
	TD_Room[playerid][12] = CreatePlayerTextDraw(playerid, 243.0000, 348.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][12], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][12], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][12], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][12], 303174399);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][12], false);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][13], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][13], -741977345);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][13], 0xFFFFFFFF);
	PlayerTextDrawFont(playerid, TD_Room[playerid][13], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][13], true);
	...
	TD_Room[playerid][14] = CreatePlayerTextDraw(playerid, 290.0000, 347.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][14], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][14], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][14], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][14], -1717986817);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][14], false);
	...
	TD_Room[playerid][15] = CreatePlayerTextDraw(playerid, 291.0000, 348.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][15], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][15], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][15], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][15], 303174399);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][15], false);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][16], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][16], 1422643711);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][16], 0xFFFFFFFF);
	PlayerTextDrawFont(playerid, TD_Room[playerid][16], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][16], true);
	PlayerTextDrawSetShadow(playerid, TD_Room[playerid][16], 0);
	PlayerTextDrawSetSelectable(playerid, TD_Room[playerid][16], true);

	// Белый фон команды
	TD_Room[playerid][17] = CreatePlayerTextDraw(playerid, 370.0000, 347.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][17], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][17], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][17], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][17], -1717986817);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][17], false);
	...
	// Чёрный фон команды
	TD_Room[playerid][18] = CreatePlayerTextDraw(playerid, 371.0000, 348.0000, "_");
	PlayerTextDrawFont(playerid, TD_Room[playerid][18], TEXT_DRAW_FONT_PREVIEW);
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][18], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_Room[playerid][18], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][18], 303174399);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][18], false);
	...
	PlayerTextDrawAlignment(playerid, TD_Room[playerid][19], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_Room[playerid][19], 2127647487);
	PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][19], 0xFFFFFFFF);
	PlayerTextDrawFont(playerid, TD_Room[playerid][19], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_Room[playerid][19], true);
...
static Room_ShowPlayersTD(playerid)
{
	...
	for(new i = 20, s = 1, num = 1; i < sizeof(TD_Room[]); i++, s++, num++) {
		TD_Room[playerid][i] = CreatePlayerTextDraw(playerid, initialcoords[0], initialcoords[1], "_");
		PlayerTextDrawFont(playerid, TD_Room[playerid][i], TEXT_DRAW_FONT_PREVIEW);
		PlayerTextDrawAlignment(playerid, TD_Room[playerid][i], TEXT_DRAW_ALIGN_LEFT);
		PlayerTextDrawColour(playerid, TD_Room[playerid][i], 0xFFFFFFFF);
		PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][i], 0x00000000);
		PlayerTextDrawSetProportional(playerid, TD_Room[playerid][i], false);
		...
		PlayerTextDrawAlignment(playerid, TD_Room[playerid][i], TEXT_DRAW_ALIGN_LEFT);
		PlayerTextDrawColour(playerid, TD_Room[playerid][i], 0x00000000);
		PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][i], 255);
		PlayerTextDrawFont(playerid, TD_Room[playerid][i], TEXT_DRAW_FONT_BANK_GOTHIC);
		PlayerTextDrawSetProportional(playerid, TD_Room[playerid][i], true);
		PlayerTextDrawSetShadow(playerid, TD_Room[playerid][i], 0);
		i++;
		...
		PlayerTextDrawAlignment(playerid, TD_Room[playerid][i], TEXT_DRAW_ALIGN_RIGHT);
		PlayerTextDrawColour(playerid, TD_Room[playerid][i], 0x00000000);
		PlayerTextDrawBackgroundColour(playerid, TD_Room[playerid][i], 255);
		PlayerTextDrawFont(playerid, TD_Room[playerid][i], TEXT_DRAW_FONT_BANK_GOTHIC);
		PlayerTextDrawSetProportional(playerid, TD_Room[playerid][i], true);
...
static Room_CreateTDResultChet(playerid, team_id, bool:td_id, num, teams)
{
	...
	PlayerTextDrawAlignment(playerid, TD_ResultRound[playerid][num][tdid], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_ResultRound[playerid][num][tdid], 0xFFFFFFFF);
	PlayerTextDrawBackgroundColour(playerid, TD_ResultRound[playerid][num][tdid], Room_ShowTeamColorXB(team_id));
	PlayerTextDrawSetProportional(playerid, TD_ResultRound[playerid][num][tdid], false);
	PlayerTextDrawSetShadow(playerid, TD_ResultRound[playerid][num][tdid], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_ResultRound[playerid][num][tdid], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_ResultRound[playerid][num][tdid], Room_ShowTeamColorXF(team_id));
	PlayerTextDrawBackgroundColour(playerid, TD_ResultRound[playerid][num][tdid], 255);
	PlayerTextDrawFont(playerid, TD_ResultRound[playerid][num][tdid], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_ResultRound[playerid][num][tdid], true);
	PlayerTextDrawSetShadow(playerid, TD_ResultRound[playerid][num][tdid], 0);
