	...
	for(new i = 0, td = 4; i < 5; i++, td += 2) {
		if(players_Data[session_id][i][1] > -1) {
			...
			if(players_Data[session_id][i][1] == playerid) {
				PlayerTextDrawColour(playerid, TD_TopKillers[playerid][td], 0xd9832eFF);
				PlayerTextDrawShow(playerid, TD_TopKillers[playerid][td]);

				PlayerTextDrawColour(playerid, TD_TopKillers[playerid][td + 1], 0xd9832eFF);
				PlayerTextDrawShow(playerid, TD_TopKillers[playerid][td + 1]);
			}
			else {
				PlayerTextDrawColour(playerid, TD_TopKillers[playerid][td], -606348801);
				PlayerTextDrawShow(playerid, TD_TopKillers[playerid][td]);

				PlayerTextDrawColour(playerid, TD_TopKillers[playerid][td + 1], -606348801);
				PlayerTextDrawShow(playerid, TD_TopKillers[playerid][td + 1]);	
			}
		}
	}
...
static ShowTDTopKillers(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_TopKillers[playerid][0], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_TopKillers[playerid][0], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_TopKillers[playerid][0], true);
	PlayerTextDrawBoxColour(playerid, TD_TopKillers[playerid][0], 640034559);
	PlayerTextDrawBackgroundColour(playerid, TD_TopKillers[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_TopKillers[playerid][0], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_TopKillers[playerid][0], true);
	...
	PlayerTextDrawAlignment(playerid, TD_TopKillers[playerid][1], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_TopKillers[playerid][1], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_TopKillers[playerid][1], true);
	PlayerTextDrawBoxColour(playerid, TD_TopKillers[playerid][1], 791621631);
	PlayerTextDrawBackgroundColour(playerid, TD_TopKillers[playerid][1], 255);
	PlayerTextDrawFont(playerid, TD_TopKillers[playerid][1], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_TopKillers[playerid][1], true);
	...
	PlayerTextDrawAlignment(playerid, TD_TopKillers[playerid][2], TEXT_DRAW_ALIGN_CENTER);
	PlayerTextDrawColour(playerid, TD_TopKillers[playerid][2], -1162168065);
	PlayerTextDrawBackgroundColour(playerid, TD_TopKillers[playerid][2], 255);
	PlayerTextDrawFont(playerid, TD_TopKillers[playerid][2], TEXT_DRAW_FONT_BANK_GOTHIC);
	PlayerTextDrawSetProportional(playerid, TD_TopKillers[playerid][2], true);
	...
	PlayerTextDrawAlignment(playerid, TD_TopKillers[playerid][3], TEXT_DRAW_ALIGN_LEFT);
	PlayerTextDrawColour(playerid, TD_TopKillers[playerid][3], 0xFFFFFFFF);
	PlayerTextDrawUseBox(playerid, TD_TopKillers[playerid][3], true);
	PlayerTextDrawBoxColour(playerid, TD_TopKillers[playerid][3], 791621631);
	PlayerTextDrawBackgroundColour(playerid, TD_TopKillers[playerid][3], 255);
	PlayerTextDrawFont(playerid, TD_TopKillers[playerid][3], TEXT_DRAW_FONT_AHARONI_BOLD);
	PlayerTextDrawSetProportional(playerid, TD_TopKillers[playerid][3], true);
	...
	n_for(i, 5) {
		...
		PlayerTextDrawAlignment(playerid, TD_TopKillers[playerid][td], TEXT_DRAW_ALIGN_LEFT);
		PlayerTextDrawColour(playerid, TD_TopKillers[playerid][td], -606348801);
		PlayerTextDrawBackgroundColour(playerid, TD_TopKillers[playerid][td], 255);
		PlayerTextDrawFont(playerid, TD_TopKillers[playerid][td], TEXT_DRAW_FONT_AHARONI_BOLD);
		PlayerTextDrawSetProportional(playerid, TD_TopKillers[playerid][td], true);
		...
		PlayerTextDrawAlignment(playerid, TD_TopKillers[playerid][td], TEXT_DRAW_ALIGN_CENTER);
		PlayerTextDrawColour(playerid, TD_TopKillers[playerid][td], -606348801);
		PlayerTextDrawBackgroundColour(playerid, TD_TopKillers[playerid][td], 255);
		PlayerTextDrawFont(playerid, TD_TopKillers[playerid][td], TEXT_DRAW_FONT_BANK_GOTHIC);
		PlayerTextDrawSetProportional(playerid, TD_TopKillers[playerid][td], true);
		PlayerTextDrawSetShadow(playerid, TD_TopKillers[playerid][td], 0);
		td++;
