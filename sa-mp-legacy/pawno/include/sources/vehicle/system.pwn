...
static ShowPlayerSpeedometer(playerid, vehicleid = 400)
{
	...
	if(!Veh_GetEngine(vehicleid))
		PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][0], -1558767617);
	else
		PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][0], 698554367);
...
{
	TD_vSpeedometer[playerid][0] = CreatePlayerTextDraw(playerid, 517.0000, 419.0000, ""); // Задний фон двигатель
	PlayerTextDrawTextSize(playerid, TD_vSpeedometer[playerid][0], 101.0000, 3.0000);
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][0], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][0], 698554367);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][0], 5);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][0], 0);
	...
	TD_vSpeedometer[playerid][1] = CreatePlayerTextDraw(playerid, 517.0000, 360.0000, ""); // Основной задний фон
	PlayerTextDrawTextSize(playerid, TD_vSpeedometer[playerid][1], 101.0000, 60.0000);
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][1], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][1], 606348543);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][1], 5);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][1], 0);
	...
	TD_vSpeedometer[playerid][2] = CreatePlayerTextDraw(playerid, 517.0000, 373.0000, ""); // Полоска
	PlayerTextDrawTextSize(playerid, TD_vSpeedometer[playerid][2], 101.0000, 2.0000);
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][2], 1);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][2], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][2], 1077952767);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][2], 5);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][2], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][3], 2);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][3], -589505793);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][3], 255);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][3], 2);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][3], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][4], 2);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][4], -239757313);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][4], 255);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][4], 2);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][4], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][5], 1);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][5], 1332724991);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][5], 255);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][5], 4);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][5], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][6], 1);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][6], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][6], 255);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][6], 4);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][6], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][7], 2);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][7], -636415489);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][7], 255);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][7], 2);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][7], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_vSpeedometer[playerid][8], 2);
	PlayerTextDrawColor(playerid, TD_vSpeedometer[playerid][8], 292477695);
	PlayerTextDrawBackgroundColor(playerid, TD_vSpeedometer[playerid][8], 255);
	PlayerTextDrawFont(playerid, TD_vSpeedometer[playerid][8], 2);
	PlayerTextDrawSetProportional(playerid, TD_vSpeedometer[playerid][8], 1);
