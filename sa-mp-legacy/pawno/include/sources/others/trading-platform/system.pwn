...
static ShowTDTradingPlatform(playerid) 
{
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][0], -1);
	PlayerTextDrawUseBox(playerid, TD_TradingPlatform[playerid][0], 1);
	PlayerTextDrawBoxColor(playerid, TD_TradingPlatform[playerid][0], 606348543);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][0], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][1], -1);
	PlayerTextDrawUseBox(playerid, TD_TradingPlatform[playerid][1], 1);
	PlayerTextDrawBoxColor(playerid, TD_TradingPlatform[playerid][1], 336860415);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][1], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][1], 1);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][1], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][2], 2);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][2], -1431656193);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][2], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][2], 0);

	// Задний чёрный фон головы
	TD_TradingPlatform[playerid][3] = CreatePlayerTextDraw(playerid, 199.0000, 140.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][3], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][3], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][3], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][3], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][3], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][3], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][4], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][4], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][4], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][4], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][4], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][4], 0);

	// Задний чёрный фон наушников
	TD_TradingPlatform[playerid][5] = CreatePlayerTextDraw(playerid, 279.0000, 140.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][5], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][5], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][5], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][5], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][5], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][5], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][6], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][6], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][6], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][6], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][6], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][6], 0);

	// Задний чёрный фон очков
	TD_TradingPlatform[playerid][7] = CreatePlayerTextDraw(playerid, 359.0000, 140.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][7], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][7], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][7], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][7], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][7], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][7], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][8], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][8], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][8], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][8], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][8], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][8], 0);

	// Задний чёрный фон масков
	TD_TradingPlatform[playerid][9] = CreatePlayerTextDraw(playerid, 199.0000, 213.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][9], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][9], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][9], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][9], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][9], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][9], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][10], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][10], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][10], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][10], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][10], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][10], 0);

	// Задний чёрный фон часов
	TD_TradingPlatform[playerid][11] = CreatePlayerTextDraw(playerid, 279.0000, 213.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][11], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][11], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][11], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][11], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][11], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][11], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][12], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][12], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][12], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][12], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][12], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][12], 0);

	// Задний чёрный фон скинов
	TD_TradingPlatform[playerid][13] = CreatePlayerTextDraw(playerid, 359.0000, 213.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][13], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][13], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][13], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][13], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][13], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][13], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][14], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][14], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][14], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][14], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][14], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][14], 0);

	// Задний чёрный фон кейсов
	TD_TradingPlatform[playerid][15] = CreatePlayerTextDraw(playerid, 240.0000, 285.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][15], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][15], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][15], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][15], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][15], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][15], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][16], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][16], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][16], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][16], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][16], 1);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][16], 0);

	// Задний чёрный фон баннеров
	TD_TradingPlatform[playerid][17] = CreatePlayerTextDraw(playerid, 321.0000, 285.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][17], 74.0000, 65.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][17], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][17], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][17], 808464639);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][17], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][17], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][18], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][18], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][18], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][18], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][18], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][19], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][19], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][19], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][19], 4);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][19], 0);
	PlayerTextDrawSetShadow(playerid, TD_TradingPlatform[playerid][19], 0);

	// Задний белый фон назад
	TD_TradingPlatform[playerid][20] = CreatePlayerTextDraw(playerid, 154.0000, 351.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][20], 42.0000, 19.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][20], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][20], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][20], -1717986817);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][20], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][20], 0);
	...
	TD_TradingPlatform[playerid][21] = CreatePlayerTextDraw(playerid, 155.0000, 352.0000, "");
	PlayerTextDrawTextSize(playerid, TD_TradingPlatform[playerid][21], 40.0000, 17.0000);
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][21], 1);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][21], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][21], 589505535);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][21], 5);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][21], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TradingPlatform[playerid][22], 2);
	PlayerTextDrawColor(playerid, TD_TradingPlatform[playerid][22], -953010945);
	PlayerTextDrawBackgroundColor(playerid, TD_TradingPlatform[playerid][22], 255);
	PlayerTextDrawFont(playerid, TD_TradingPlatform[playerid][22], 2);
	PlayerTextDrawSetProportional(playerid, TD_TradingPlatform[playerid][22], 1);
...
static ShowTDSlotItemsTP(playerid, item_id, td, model_id, price, goldcoins) 
{
	...
	TD_TPItem[playerid][td] = CreatePlayerTextDraw(playerid, pos_td[item_id][0], pos_td[item_id][1], ""); // Кликабельный фон 1
	PlayerTextDrawTextSize(playerid, TD_TPItem[playerid][td], 78.0000, 78.0000);
	PlayerTextDrawAlignment(playerid, TD_TPItem[playerid][td], 1);
	PlayerTextDrawColor(playerid, TD_TPItem[playerid][td], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_TPItem[playerid][td], 1111638783);
	PlayerTextDrawFont(playerid, TD_TPItem[playerid][td], 5);
	PlayerTextDrawSetProportional(playerid, TD_TPItem[playerid][td], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_TPItem[playerid][td + 1], 3);
	PlayerTextDrawColor(playerid, TD_TPItem[playerid][td + 1], 142945535);
	PlayerTextDrawBackgroundColor(playerid, TD_TPItem[playerid][td + 1], 255);
	PlayerTextDrawFont(playerid, TD_TPItem[playerid][td + 1], 2);
	PlayerTextDrawSetProportional(playerid, TD_TPItem[playerid][td + 1], 1);
	...
	switch(TP_PlayerInfo[playerid][TP_BuyItems]) {
		case 7: { // Баннеры
			...
			PlayerTextDrawAlignment(playerid, TD_TPItem[playerid][td + 2], 1);
			PlayerTextDrawColor(playerid, TD_TPItem[playerid][td + 2], -1);
			PlayerTextDrawBackgroundColor(playerid, TD_TPItem[playerid][td + 2], 255);
			PlayerTextDrawFont(playerid, TD_TPItem[playerid][td + 2], 4);
			PlayerTextDrawSetProportional(playerid, TD_TPItem[playerid][td + 2], 0);
...
static ShowBlockItemsTP(playerid, change_slot, bool:trans_text = false)
{
	...
	PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][td_id], 757935615);
	...
	PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][td_id], 0x0e5408FF);
	PlayerTextDrawShow(playerid, TD_TPBlocks[playerid][td_id]);
...
static ShowBuyTDTradingPlatform(playerid, items_id, page = 1, block = 1, bool:perevod_text = false)
{
	...
	switch(items_id) {
		case 0: { // Голова
			...
			TD_TPBlocks[playerid][0] = CreatePlayerTextDraw(playerid, 155.0000, 149.0000, ""); // Кликабельный фон 1
			PlayerTextDrawTextSize(playerid, TD_TPBlocks[playerid][0], 71.0000, 15.0000);
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][0], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][0], -1);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][0], 757935615);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][0], 5);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][0], 0);
			...
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][1], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][1], -1212697089);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][6], 255);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][1], 2);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][1], 1);
			PlayerTextDrawSetShadow(playerid, TD_TPBlocks[playerid][1], 0);

			TD_TPBlocks[playerid][2] = CreatePlayerTextDraw(playerid, 155.0000, 165.0000, ""); // Кликабельный фон 2
			PlayerTextDrawTextSize(playerid, TD_TPBlocks[playerid][2], 71.0000, 15.0000);
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][2], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][2], -1);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][2], 757935615);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][2], 5);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][2], 0);
			...
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][3], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][3], -1212697089);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][3], 255);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][3], 2);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][3], 1);
			PlayerTextDrawSetShadow(playerid, TD_TPBlocks[playerid][3], 0);

			TD_TPBlocks[playerid][4] = CreatePlayerTextDraw(playerid, 155.0000, 181.0000, ""); // Кликабельный фон 3
			PlayerTextDrawTextSize(playerid, TD_TPBlocks[playerid][4], 71.0000, 15.0000);
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][4], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][4], -1);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][4], 757935615);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][4], 5);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][4], 0);
			...
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][5], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][5], -1212697089);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][5], 255);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][5], 2);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][5], 1);
			PlayerTextDrawSetShadow(playerid, TD_TPBlocks[playerid][5], 0);

			TD_TPBlocks[playerid][6] = CreatePlayerTextDraw(playerid, 155.0000, 197.0000, ""); // Кликабельный фон 4
			PlayerTextDrawTextSize(playerid, TD_TPBlocks[playerid][6], 71.0000, 15.0000);
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][6], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][6], -1);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][6], 757935615);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][6], 5);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][6], 0);
			...
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][7], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][7], -1212697089);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][7], 255);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][7], 2);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][7], 1);
			PlayerTextDrawSetShadow(playerid, TD_TPBlocks[playerid][7], 0);
		
			TD_TPBlocks[playerid][8] = CreatePlayerTextDraw(playerid, 155.0000, 213.0000, ""); // Кликабельный фон 5
			PlayerTextDrawTextSize(playerid, TD_TPBlocks[playerid][8], 71.0000, 15.0000);
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][8], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][8], -1);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][8], 757935615);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][8], 5);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][8], 0);
			...
			PlayerTextDrawAlignment(playerid, TD_TPBlocks[playerid][9], 1);
			PlayerTextDrawColor(playerid, TD_TPBlocks[playerid][9], -1212697089);
			PlayerTextDrawBackgroundColor(playerid, TD_TPBlocks[playerid][9], 255);
			PlayerTextDrawFont(playerid, TD_TPBlocks[playerid][9], 2);
			PlayerTextDrawSetProportional(playerid, TD_TPBlocks[playerid][9], 1);
...
static ShowTDBuyTradingPlatform(playerid)
{
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][0], -1);
	PlayerTextDrawUseBox(playerid, TD_BTradingPlatform[playerid][0], 1);
	PlayerTextDrawBoxColor(playerid, TD_BTradingPlatform[playerid][0], 606348543);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][0], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][0], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][1], -1);
	PlayerTextDrawUseBox(playerid, TD_BTradingPlatform[playerid][1], 1);
	PlayerTextDrawBoxColor(playerid, TD_BTradingPlatform[playerid][1], 336860415);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][1], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][1], 1);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][1], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][2], 2);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][2], -1431656193);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][2], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][2], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][3], 1);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][3], -1);
	PlayerTextDrawUseBox(playerid, TD_BTradingPlatform[playerid][3], 1);
	PlayerTextDrawBoxColor(playerid, TD_BTradingPlatform[playerid][3], 336860415);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][3], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][3], 1);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][3], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][4], 1);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][4], 0xc73234FF);
	PlayerTextDrawUseBox(playerid, TD_BTradingPlatform[playerid][4], 1);
	PlayerTextDrawBoxColor(playerid, TD_BTradingPlatform[playerid][4], 0);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][4], 2);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][4], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][5], 1);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][5], -1212697089);
	PlayerTextDrawUseBox(playerid, TD_BTradingPlatform[playerid][5], 1);
	PlayerTextDrawBoxColor(playerid, TD_BTradingPlatform[playerid][5], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][5], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][5], 1);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][5], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][6], 2);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][6], -1212697089);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][6], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][6], 1);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][6], 1);
	...
	PlayerTextDrawAlignment(playerid, TD_BTradingPlatform[playerid][7], 1);
	PlayerTextDrawColor(playerid, TD_BTradingPlatform[playerid][7], -1212697089);
	PlayerTextDrawUseBox(playerid, TD_BTradingPlatform[playerid][7], 1);
	PlayerTextDrawBoxColor(playerid, TD_BTradingPlatform[playerid][7], 0);
	PlayerTextDrawBackgroundColor(playerid, TD_BTradingPlatform[playerid][7], 255);
	PlayerTextDrawFont(playerid, TD_BTradingPlatform[playerid][7], 1);
	PlayerTextDrawSetProportional(playerid, TD_BTradingPlatform[playerid][7], 1);
