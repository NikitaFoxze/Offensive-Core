...
{
	// Задний фон
	TD_MainMenu[playerid][0] = CreatePlayerTextDraw(playerid, 116.0000, 123.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][0], 89.0000, 25.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][0], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][0], -1701143809);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][0], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][0], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][1] = CreatePlayerTextDraw(playerid, 117.0000, 124.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][1], 87.0000, 23.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][1], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][1], -468380161);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][1], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][1], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][2], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][2], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][2], 48);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, TD_MainMenu[playerid][2], 1);

	// Задний фон
	TD_MainMenu[playerid][3] = CreatePlayerTextDraw(playerid, 116.0000, 155.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][3], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][3], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][3], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][3], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][3], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][3], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][4] = CreatePlayerTextDraw(playerid, 117.0000, 156.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][4], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][4], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][4], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][4], 0x911111FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][4], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][4], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][5], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][5], -218959617);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][5], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][5], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][5], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][6] = CreatePlayerTextDraw(playerid, 116.0000, 182.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][6], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][6], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][6], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][6], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][6], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][6], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][7] = CreatePlayerTextDraw(playerid, 117.0000, 183.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][7], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][7], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][7], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][7], 0x911111FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][7], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][7], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][8], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][8], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][8], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][8], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][8], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][9] = CreatePlayerTextDraw(playerid, 116.0000, 209.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][9], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][9], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][9], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][9], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][9], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][9], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][10] = CreatePlayerTextDraw(playerid, 117.0000, 210.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][10], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][10], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][10], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][10], 0x911111FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][10], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][10], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][11], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][11], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][11], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][11], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][11], 1);
	...
	PlayerTextDrawSetSelectable(playerid, TD_MainMenu[playerid][11], true);
	 ...
	 // Задний фон
	TD_MainMenu[playerid][12] = CreatePlayerTextDraw(playerid, 116.0000, 236.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][12], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][12], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][12], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][12], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][12], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][12], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][13] = CreatePlayerTextDraw(playerid, 117.0000, 237.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][13], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][13], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][13], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][13], 0x8214a3FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][13], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][13], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][14], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][14], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][14], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][14], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][14], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][15] = CreatePlayerTextDraw(playerid, 116.0000, 263.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][15], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][15], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][15], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][15], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][15], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][15], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][16] = CreatePlayerTextDraw(playerid, 117.0000, 264.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][16], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][16], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][16], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][16], 0x8214a3FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][16], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][16], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][17], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][17], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][17], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][17], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][17], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][18] = CreatePlayerTextDraw(playerid, 116.0000, 290.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][18], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][18], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][18], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][18], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][18], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][18], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][19] = CreatePlayerTextDraw(playerid, 117.0000, 291.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][19], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][19], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][19], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][19], 0x8214a3FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][19], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][19], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][20], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][20], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][20], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][20], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][20], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][21] = CreatePlayerTextDraw(playerid, 116.0000, 317.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][21], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][21], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][21], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][21], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][21], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][21], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][22] = CreatePlayerTextDraw(playerid, 117.0000, 318.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][22], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][22], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][22], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][22], 0x118da8FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][22], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][22], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][23], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][23], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][23], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][23], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][23], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][24] = CreatePlayerTextDraw(playerid, 116.0000, 344.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][24], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][24], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][24], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][24], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][24], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][24], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][25] = CreatePlayerTextDraw(playerid, 117.0000, 345.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][25], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][25], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][25], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][25], 0x118da8FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][25], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][25], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][26], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][26], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][26], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][26], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][26], 1);
	...
	// Задний фон
	TD_MainMenu[playerid][27] = CreatePlayerTextDraw(playerid, 116.0000, 371.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][27], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][27], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][27], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][27], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][27], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][27], 0);
	...
	// Кликабельный фон
	TD_MainMenu[playerid][28] = CreatePlayerTextDraw(playerid, 117.0000, 372.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MainMenu[playerid][28], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][28], 1);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][28], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][28], 0x118da8FF);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][28], 5);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][28], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MainMenu[playerid][29], 2);
	PlayerTextDrawColor(playerid, TD_MainMenu[playerid][29], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MainMenu[playerid][29], 0x00000020);
	PlayerTextDrawFont(playerid, TD_MainMenu[playerid][29], 2);
	PlayerTextDrawSetProportional(playerid, TD_MainMenu[playerid][29], 1);
...
{
	// Задний фон
	TD_MMConnect[playerid][0] = CreatePlayerTextDraw(playerid, 116.0000, 123.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][0], 89.0000, 25.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][0], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][0], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][0], -1701143809);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][0], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][0], 0);
	...
	// Кликабельный фон
	TD_MMConnect[playerid][1] = CreatePlayerTextDraw(playerid, 117.0000, 124.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][1], 87.0000, 23.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][1], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][1], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][1], -468380161);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][1], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][1], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][2], 2);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][2], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][2], 48);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][2], 2);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, TD_MMConnect[playerid][2], 1);

	// Задний фон
	TD_MMConnect[playerid][3] = CreatePlayerTextDraw(playerid, 116.0000, 155.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][3], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][3], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][3], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][3], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][3], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][3], 0);
	...
	// Кликабельный фон
	TD_MMConnect[playerid][4] = CreatePlayerTextDraw(playerid, 117.0000, 156.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][4], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][4], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][4], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][4], 0x31cf23FF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][4], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][4], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][5], 2);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][5], -218959617);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][5], 80);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][5], 2);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][5], 1);
	...
	// Задний фон
	TD_MMConnect[playerid][6] = CreatePlayerTextDraw(playerid, 116.0000, 182.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][6], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][6], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][6], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][6], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][6], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][6], 0);
	...
	// Кликабельный фон
	TD_MMConnect[playerid][7] = CreatePlayerTextDraw(playerid, 117.0000, 183.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][7], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][7], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][7], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][7], 0xcf9323FF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][7], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][7], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][8], 2);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][8], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][8], 80);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][8], 2);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][8], 1);
	...
	// Задний фон
	TD_MMConnect[playerid][9] = CreatePlayerTextDraw(playerid, 116.0000, 209.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][9], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][9], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][9], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][9], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][9], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][9], 0);
	...
	// Кликабельный фон
	TD_MMConnect[playerid][10] = CreatePlayerTextDraw(playerid, 117.0000, 210.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][10], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][10], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][10], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][10], 0x23cfcfFF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][10], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][10], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][11], 2);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][11], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][11], 80);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][11], 2);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][11], 1);
	...
	// Задний фон
	TD_MMConnect[playerid][12] = CreatePlayerTextDraw(playerid, 116.0000, 236.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][12], 89.0000, 24.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][12], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][12], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][12], 0x3d3d3dFF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][12], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][12], 0);
	...
	// Кликабельный фон
	TD_MMConnect[playerid][13] = CreatePlayerTextDraw(playerid, 117.0000, 237.0000, "");
	PlayerTextDrawTextSize(playerid, TD_MMConnect[playerid][13], 87.0000, 22.0000);
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][13], 1);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][13], -1);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][13], 0xcf2323FF);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][13], 5);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][13], 0);
	...
	PlayerTextDrawAlignment(playerid, TD_MMConnect[playerid][14], 2);
	PlayerTextDrawColor(playerid, TD_MMConnect[playerid][14], -353703681);
	PlayerTextDrawBackgroundColor(playerid, TD_MMConnect[playerid][14], 80);
	PlayerTextDrawFont(playerid, TD_MMConnect[playerid][14], 2);
	PlayerTextDrawSetProportional(playerid, TD_MMConnect[playerid][14], 1);
...
public OnGameModeInit()
{
	...
	ApplyActorAnimation(MainMenu_Actors[0], "SMOKING", "M_smkstnd_loop", 4.1, 1, 0, 0, 0, 0);
	ApplyActorAnimation(MainMenu_Actors[1], "BD_FIRE", "M_smklean_loop", 4.1, 1, 0, 0, 0, 0);
	ApplyActorAnimation(MainMenu_Actors[2], "PED", "IDLE_CHAT", 4.1, 1, 0, 0, 0, 0);
	ApplyActorAnimation(MainMenu_Actors[3], "MISC", "Idle_Chat_02", 4.1, 1, 0, 0, 0, 0);
	ApplyActorAnimation(MainMenu_Actors[4], "RYDER", "RYD_BECKON_01", 4.1, 1, 0, 0, 0, 0);
	ApplyActorAnimation(MainMenu_Actors[5], "BEACH", "Lay_Bac_Loop", 4.1, 1, 0, 0, 0, 0);
